...
import {PluginData} from '../../../lib/plugin/plugin.js';
import Project from '../../../lib/project/project.js';
import ProjectTaskDetails from '../../../lib/project/project-task-details/project-task-details.js';
import Editor from '../../../lib/ui/editor/editor.js';
...
export default class AgileTaskDetail {
  constructor(@Inject(Project) project, @Inject(ProjectTaskDetails) projectTaskDetails, @Inject(PluginData) placementData) {
